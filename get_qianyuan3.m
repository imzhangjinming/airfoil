function [uv_top2,uv_bot2] = get_qianyuan3(uv_top,flag_top ,uv_bot,flag_bot,lethk ,chi_in ,...
    xishu)
...
A_uv = [yichuan 0 , zeros(1,5) ;...
        zeros(1,5) , yichuan 0 ;...
        0 yichuan , zeros(1,5) ;...
        zeros(1,5) , 0 yichuan ;...
        k1*[yichuanp , 0 ] , -1*[yichuanp , 0];...
        k2*[0 , yichuanp ] , -1*[0 , yichuanp];...
        kk1*[yichuanpp , 0 ] , -1*[yichuanpp , 0];...
        kk2*[0 , yichuanpp ] , -1*[0 , yichuanpp];...
        kkk1*[yichuanppp , 0 ] , -1*[yichuanppp , 0];...
        kkk2*[0 , yichuanppp ] , -1*[0 , yichuanppp];...
        ] ;
b_uv = [P1(1,1),P1(1,2),P2(1,1),P2(1,2),0,0,0,0,0,0]' ; 
